...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> getWords = getTokens("[a-zA-Z]+");
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		List<String> getSentences = getTokens("[^.!?]+");
	...
	public int getNumSyllables()
	{
		...
		for(int i = 0; i < getWords.size(); i++){
			int wordSyllables = countSyllables(getWords.get(i));
			allSyllables = allSyllables + wordSyllables;
			//System.out.println(wordSyllables+" "+allSyllables);
		}
        return allSyllables;
	}
