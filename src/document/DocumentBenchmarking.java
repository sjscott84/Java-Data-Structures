...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			float totalTimeBasic = (endTimeBasic - startTimeBasic)/1000000000f;
				
			long startTimeE = System.nanoTime();
			for(int i = 0; i <= trials; i++){
				EfficientDocument docE = new EfficientDocument(line);
				docE.getFleschScore();
			}
			long endTimeE = System.nanoTime();
			float totalTimeE = (endTimeE - startTimeE)/1000000000f;
			System.out.println(numToCheck+"\t"+totalTimeBasic+"\t"+totalTimeE);
